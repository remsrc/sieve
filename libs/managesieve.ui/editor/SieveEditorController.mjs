 ...
 *
 * Summary:
 * No structural changes; validated compatibility with new indentation model.
 *
 * Details:
 * - Verified pass-through handling for:
 *     get-preference, set-preference,
 *     get-default-preference, set-default-preference.
 * - Confirmed support for new key "indentation-unit".
 *
 * Rationale:
 * Required to ensure IPC layer transparently forwards new editor settings
 * without introducing validation or key restrictions.
 */
