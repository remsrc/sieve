 ...
 *
 * Summary:
 * Adjusted editor initialization to support updated indentation model.
 *
 * Details:
 * - Ensured integration with updated SieveTextEditor (CM6-based).
 * - loadSettings() now relies on "indentation-unit" instead of legacy keys.
 * - Stabilized render pipeline after settings refactor.
 *
 * Rationale:
 * Prevents initialization failure caused by outdated indentation settings
 * and ensures consistent editor state during startup.
 */
