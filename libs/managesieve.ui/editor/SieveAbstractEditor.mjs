 ...
 *
 * Summary:
 * No direct changes; compatibility review only.
 *
 * Details:
 * - Verified that abstract editor layer does not depend on
 *   legacy indentation APIs.
 * - Confirmed no conflicts with CM6-based indentation handling.
 *
 * Rationale:
 * Ensures base editor abstraction remains stable after migration
 * to "indentation-unit".
 */
const HEX = 16;
const HEX_LENGTH = 2;
