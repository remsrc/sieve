...
/**
 * CHANGE (remsrc):
 * Added explicit Bootstrap theme initialization.
 *
 * - Synchronizes UI with system dark/light mode
 * - Sets "data-bs-theme" on document root
 *
 * Rationale:
 * Unlike the account view, the editor did not automatically inherit
 * the correct theme, resulting in inconsistent appearance.
 */
