...
export { Compartment, EditorState, EditorView, SearchQuery, StreamLanguage, Transaction, basicSetup, closeSearchPanel, findNext, findPrevious, getSearchQuery, indentUnit, indentWithTab, keymap, openSearchPanel, redo, replaceAll, replaceNext, search, setSearchQuery, sieve, undo, undoDepth };
