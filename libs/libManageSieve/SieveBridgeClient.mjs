...
class SieveBridgeClient {
  ...
  onDisconnect() {
    ...
    console.error(`[SieveBridge] ${message}`);
  ...
  async getCredentialBackend() {
    return await this.request("credential.backend");
  }

  async setCredential(credentialId, password) {
    return await this.request("credential.set", { credentialId, password });
  }

  async getCredential(credentialId) {
    return await this.request("credential.get", { credentialId });
  }

  async hasCredential(credentialId) {
    return await this.request("credential.exists", { credentialId });
  }

  async deleteCredential(credentialId) {
    return await this.request("credential.delete", { credentialId });
  }
